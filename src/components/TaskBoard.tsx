...
export default function TaskBoard({ tasks, dealId, onAskAI}: { tasks: any[], dealId: string, onAskAI?: (task: any) => void}) {
 ...
 <div 
 key={col.id} 
 className="flex-1 min-w-[300px] flex flex-col bg-gray-50 border-2 border-black"
...
>
 ...
 className="bg-white border-2 border-black p-3 cursor-move hover:bg-gray-50 transition-all group flex flex-col"
>
...
'bg-green-200 text-green-900'
 ...
 variant="outline" 
 size="sm" 
 className="mt-3 w-full border-2 border-black text-[10px] h-7"
