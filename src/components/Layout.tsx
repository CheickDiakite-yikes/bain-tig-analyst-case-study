    ...
    <div className="flex h-[100dvh] bg-background text-foreground overflow-hidden">
      ...
      >
        <button 
          ...
          className="hidden md:block absolute -right-3.5 top-8 bg-white border-2 border-black rounded-sm p-1 z-30 hover:bg-gray-100 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
        >
      ...
      <main className="flex-1 overflow-hidden flex flex-col bg-[#F4F4F0] relative">
        ...
        <div className="md:hidden flex items-center p-4 border-b-2 border-black bg-white shrink-0">
          <button onClick={() => setIsSidebarOpen(true)} className="p-2 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] bg-white">
