...
>
 ...
 <Button variant="outline" size="sm" onClick={() => setInput("Summarize the files in the data room.")} className="border-2 border-black">Summarize Files</Button>
 <Button variant="outline" size="sm" onClick={() => setInput("Generate a Tech DD Memo outline.")} className="border-2 border-black">Draft Memo</Button>
 </div>
 </div>
 ) : (
 ...
 <div className={`max-w-[85%] md:max-w-[80%] p-3 md:p-4 border-2 border-black  overflow-hidden ${
 msg.role ==='user' 
 ?'bg-white text-black' 
 : msg.role ==='system'
...
>
 ...
 <div className="flex-shrink-0 w-8 h-8 bg-[#CC0000] flex items-center justify-center text-white border-2 border-black">
 <BrainCircuit className="w-4 h-4" />
 </div>
 <div className="bg-white border-2 border-black  p-3 md:p-4 flex flex-col gap-2 max-w-[85%] md:max-w-[80%] overflow-hidden">
 <div className="flex items-center gap-2">
...
>
 ...
 <div key={i} className="flex items-center gap-2 bg-white text-black px-3 py-1.5 text-xs border-2 border-black font-bold">
...
>
 ...
 disabled={isTyping}
 />
 <Button type="submit" disabled={(!input.trim() && attachments.length === 0) || isTyping} size="icon" className="bg-[#CC0000] text-white flex-shrink-0 border-2 border-black hover:bg-red-700">
